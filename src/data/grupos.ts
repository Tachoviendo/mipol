 ...
 *
 * - Docentes crean grupos, publican, comparten materiales, crean tareas y
 *   hacen seguimiento de quiénes entregaron y quiénes faltan.
 * - Estudiantes participan, comentan y entregan sus tareas.
 ...
 * entregada / calificada), nota y fecha de entrega. Eso permite al docente
 * ver el listado de quién entregó y quién falta.
 *
...
export const tareasMock: Tarea[] = [
  ...
  },
  {
    ...
    entregas: [
      { estudianteId: "u1", estado: "pendiente" },
      { estudianteId: "u5", estado: "pendiente" },
      { estudianteId: "u15", estado: "pendiente" },
      { estudianteId: "u16", estado: "pendiente" },
    ],
  },
  {
