 ...
 *
 * - Docentes y administración crean grupos indicando nombre, materia, curso
 *   y miembros (GR-06). El grupo nuevo aparece en "Mis grupos" (GR-02) de
 *   cada miembro y del docente que lo crea.
 * - Docentes crean tareas y hacen seguimiento de quiénes entregaron y
 *   quiénes faltan; estudiantes participan, comentan y entregan.
 * - Administración tiene visibilidad global; público no accede.
 *
