...
export default async function GruposPage({
  ...
  const nombreMostrado = await obtenerNombreMostrado();
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-10">
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          ...
                          <p className="mt-1 text-xs text-zinc-500">
                            {grupo.miembroIds.length}{" "}
                            {grupo.miembroIds.length === 1 ? "integrante" : "integrantes"}
                          </p>
                        </div>
        ...
        {nombreMostrado && (
          <p className="text-center text-xs text-zinc-500">
            Participando como {nombreMostrado}
          </p>
        )}
      </main>
    </div>
